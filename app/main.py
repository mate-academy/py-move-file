...
def move_file(command: str) -> None:
    parts = command.split()
    if len(parts) != 3:
        raise ValueError("Command must contain exactly three parts: 'mv', 'file_name', and 'directory'")
    ...
    if name_file == directory or directory == "":
        raise ValueError("The file name and directory cannot be the same or empty")
